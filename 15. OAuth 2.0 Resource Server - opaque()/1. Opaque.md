...
<img src="https://github.com/user-attachments/assets/306195d2-2d3b-428d-83c2-6b3e3787145e">
   ...
   - http://localhost:8080/realms/oauth2/protocol/openid-connect/introsepct는 인가 서버가 호스트하는 introspection 엔드포인트
...
protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (token == null) {
            ...
            try {
                ...
                Authentication authenticationResult = authenticationManager.authenticate(authenticationRequest); // OpaqueTokenAuthenticationProvider하여 인증 처리
