...
public class AuthorizationServerConfig {
    ...
    private KeyPair generateRsaKey() throws NoSuchAlgorithmException {
        ...
        keyPairGenerator.generateKeyPair(); // 두 개의 키 쌍을 만듬
...
3. 임시 코드 요청 (GET ```http://localhost:9000/oauth2/authorize?response_type=code&clinet_id=oauth2-client-app&scope=openid read write&redirect_uri=http://127.0.0.1:8081```)
